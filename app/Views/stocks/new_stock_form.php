...
<form method="post" action="<?= base_url('stocks/new_stock') ?>">
    <input type="hidden" name="created_at" value="<?= date('Y-m-d') ?>">
    <label>Stock Code</label>
    <input type="text" name="stock_code" value="<?= $stock_code ?>" readonly><br>
    ...
    <input type="date" name="stock_date" required><br>
